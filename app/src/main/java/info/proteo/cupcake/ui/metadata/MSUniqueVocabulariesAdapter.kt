...
class MSUniqueVocabulariesAdapter : ListAdapter<MSUniqueVocabulariesEntity, MSUniqueVocabulariesAdapter.ViewHolder>(DiffCallback()) {
    ...
    class DiffCallback : DiffUtil.ItemCallback<MSUniqueVocabulariesEntity>() {
